...
CACHE_DIR="${HOME}/.cache/autoimprove"
...
LATEST_VERSION=$(timeout 3 gh api repos/benmarte/autoimprove/releases/latest --jq '.tag_name' 2>/dev/null | sed 's/^v//' || echo "")
